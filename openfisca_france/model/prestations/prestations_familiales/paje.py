...
class paje_base(Variable):
    ...
    def formula_2018_04_01(famille, period, parameters):
        ...
        def plafond_taux_plein_apres_avril_2018():
            ...
            if period.start.date >= date(2018, 4, 01):
        ...
        def montant_enfant_ne_apres_avril_2014_avant_avril_2018():
            ...
            montant = (
                ...
                (ressources <= plafond_taux_partiel_apres_avril_2014_avant_avril_2018()) * (ressources > plafond_taux_plein_apres_avril_2014_avant_avril_2018()) * montant_taux_partiel
                )
            return montant
        ...
        def montant_enfant_ne_apres_avril_2018():
            ...
            montant = (
                ...
                (ressources <= plafond_taux_partiel_apres_avril_2018()) * (ressources > plafond_taux_plein_apres_avril_2018()) * montant_taux_partiel
                )
            return montant
        ...
        montant = (
            ...
            not_(enfant_elig_avant_avril_2014) * not_(enfant_eligible_ne_apres_avril_2018) * enfant_eligible_ne_apres_avril_2014_avant_avril_2018 * montant_elig_apres_avril_2014_avant_avril_2018 +
            not_(enfant_elig_avant_avril_2014) * not_(enfant_eligible_ne_apres_avril_2014_avant_avril_2018) * enfant_eligible_ne_apres_avril_2018 * montant_elig_apres_avril_2018
            )
...
class paje_naissance(Variable):
    ...
    def formula_2018_04_01(famille, period, parameters):
        ...
        taux_plafond = (nbenf > 0) + P.paje.base.apres_2018.taux_majoration_2_premiers_enf * min_(nbenf, 2) + P.paje.base.apres_2018.taux_majoration_3eme_enf_et_plus * max_(nbenf - 2, 0)
        majoration_isole_biactif = isole | biactivite
        plafond_de_ressources = P.paje.base.apres_2018.plafond_ressources_0_enf * taux_plafond + (taux_plafond > 0) * P.paje.base.apres_2018.majoration_biact_parent_isoles * majoration_isole_biactif
